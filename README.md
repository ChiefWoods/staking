...
NFT staking for [Turbin3 Builders Cohort](https://turbin3.com/).

[Source Repository](https://github.com/ChiefWoods/staking)
...
```bash
git clone https://github.com/ChiefWoods/staking.git
```
...
```bash
anchor idl init -f target/idl/staking.json <PROGRAM_ID>
```

## Issues

View the [open issues](https://github.com/ChiefWoods/staking/issues) for a full list of proposed features and known bugs.
